...
public class CustomerAccountService {
    ...
    public CustomerAccountService(UserService userService,
    ...
    public void forgottenPassword(String email) throws EntityNotFoundException, DuplicateEntityException {
    ...
    protected void sendResetPasswordEmail(User user) throws DuplicateEntityException {
        ...
        String link = "http://localhost:8080/password/change?token=" + confirmationToken.getToken();
